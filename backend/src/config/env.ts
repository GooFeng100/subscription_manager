...
const envSchema = z.object({
  ...
  TURNSTILE_LOGIN_ENABLED: z.string().optional(),
  TURNSTILE_REGISTER_ENABLED: z.string().optional(),
  LOGIN_TURNSTILE_ENABLED: z.string().optional(),
  REGISTER_TURNSTILE_ENABLED: z.string().optional(),
  TURNSTILE_SITE_KEY: z.string().optional(),
  TURNSTILE_SECRET_KEY: z.string().optional(),
  CONVERTER_BACKEND_URL: z.string().optional(),
  CONVERTER_SOURCE_SECRET: z.string().optional(),
